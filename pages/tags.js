  ...
  return (
    <div>
      ...
      <div className="container mx-auto prose prose:slate">
        ...
        {props.tags.map((tag) => (
          <Link href={'./tagged/' + tag} key={tag}>
            <a className="bg-gray-100 hover:bg-gray-100 text-gray-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded no-underline dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-700">
              {tag}
            </a>
          </Link>
        ))}
